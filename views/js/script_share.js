...
/**
 * 
 * @param {string} valor valor del elemento de un cuadro de texto
 * @returns {string}
 */
...
/**
 * 
 * @param {object} element elemento html de un formulario (un cuadro de texto)
 * @returns Retorna un string limpio sin espacios y minuscula
 */
function tratar_elemento(element){    
    return tratar_valor(element.value);
}
